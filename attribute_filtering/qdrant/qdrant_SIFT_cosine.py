...
def read_dataset():
    ...
    with open(f'{os.getenv("AF_GROUND_TRUTH_DIR")}AF_SIFT_COSINE_GT.pkl', 'rb') as f:
        truth = pickle.load(f)
...
def main():
    ...
    file_name = f"{results_dir}qdrant_SIFT_cosine_af{current_date}.csv"
    # print(datetime)
    ...
    for ef_construct in ef_construct_values:
        for m in m_values:
            for ef in ef_values:
                ...
                collection_name = "AF_SIFT_COSINE"
