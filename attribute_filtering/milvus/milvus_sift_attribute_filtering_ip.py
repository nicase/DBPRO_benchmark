...
with open(os.getenv('AF_SIFT_COSINE_GT_PATH'), 'rb') as f:
    truth = pickle.load(f)
...
COLLECTION_NAME = "MILVUS_SIFT_EXPERIMENT_ATTRIBUTE_FILTERING_IP"
...
write_to_csv('MILVUS_SIFT_EXPERIMENT_ATTRIBUTE_FILTERING_IP.csv', experiment_results)
