...
with open(os.getenv('AF_gloVe_EUCLIDEAN_GT_PATH'), 'rb') as f:
    truth = pickle.load(f)
...
COLLECTION_NAME = "MILVUS_GLOVE_EXPERIMENT_ATTRIBUTE_FILTERING_EUCLIDEAN"
...
write_to_csv('MILVUS_GLOVE_EXPERIMENT_ATTRIBUTE_FILTERING_EUCLIDEAN.csv', experiment_results)
