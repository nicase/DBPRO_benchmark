...
with open(os.getenv('AF_gloVe_COSINE_GT_PATH'), 'rb') as f:
    truth = pickle.load(f)
...
COLLECTION_NAME = "MILVUS_GLOVE_EXPERIMENT_ATTRIBUTE_FILTERING_COSINE"
...
write_to_csv('MILVUS_GLOVE_EXPERIMENT_ATTRIBUTE_FILTERING_COSINE.csv', experiment_results)
