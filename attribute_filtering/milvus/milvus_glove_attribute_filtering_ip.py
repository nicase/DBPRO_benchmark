...
COLLECTION_NAME = "MILVUS_GLOVE_EXPERIMENT_ATTRIBUTE_FILTERING_IP"
...
def run_experiment(run_ivf, m, ef, ef_search, lim, query_attr1, query_attr2, query_attr3):
    ...
    dim = 100  # Dimension of SIFT vectors
    ...
    schema = CollectionSchema(fields=[field1, field2, field3, field4, field5], description="GLOVE dataset collection")
    ...
    # Define an index type and its parameters
    ivf_flat_params = {
        "metric_type": "IP",   # or any other metric type suitable for your data
...
write_to_csv('MILVUS_GLOVE_EXPERIMENT_ATTRIBUTE_FILTERING_IP.csv', experiment_results)
