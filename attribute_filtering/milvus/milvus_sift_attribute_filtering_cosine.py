...
COLLECTION_NAME = "MILVUS_SIFT_EXPERIMENT_ATTRIBUTE_FILTERING_COSINE"
...
write_to_csv('MILVUS_SIFT_EXPERIMENT_ATTRIBUTE_FILTERING_COSINE.csv', experiment_results)
