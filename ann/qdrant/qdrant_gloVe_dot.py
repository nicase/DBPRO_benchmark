...
def read_dataset():
    ...
    with open(f'{os.getenv("ANN_GROUND_TRUTH_DIR")}ANN_gloVe_DOT_GT.pkl', 'rb') as f:
...
def main():
    ...
    file_name = f"{results_dir}qdrant_gloVe_dot_ann{current_date}.csv"
    # print(datetime)
