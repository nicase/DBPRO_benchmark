...
def read_dataset():
    ...
    with open(f'{os.getenv("ANN_GROUND_TRUTH_DIR")}ANN_gloVe_COSINE_GT.pkl', 'rb') as f:
...
def main():
    ...
    file_name = f"{results_dir}qdrant_gloVe_cosine_ann{current_date}.csv"
    ...
    for ef_construct in ef_construct_values:
        for m in m_values:
            for ef in ef_values:
                ...
                collection_name = "ANN_gloVe_COSINE"
