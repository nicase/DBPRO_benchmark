...
with open(os.getenv("ANN_gloVe_DOT_GT_PATH"), 'rb') as f:
    groundTruth = pickle.load(f)

vector_ids = list(range(len(base_vectors)))

COLLECTION_NAME = "GLOVE_EXPERIMENT_ANN_IP"
...
write_to_csv('experiment_results_ann_milvus_glove_ip.csv', experiment_results)
