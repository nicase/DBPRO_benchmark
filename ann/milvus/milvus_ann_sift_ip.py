...
ground_truth = list(ivecs_read(os.getenv('ANN_SIFT_DOT_GT_PATH')))


vector_ids = list(range(len(base_vectors)))

COLLECTION_NAME = "SIFT_EXPERIMENT_ANN_IP"
...
write_to_csv('experiment_results_ann_milvus_ip.csv', experiment_results)